...
$__System.register('5', ['4'], function (_export) {
  var _classCallCheck, UserController;
  ...
  return {
    ...
    execute: function () {
      ...
      UserController = function UserController($scope, $rootScope, socket, $http) {
...
$__System.register('6', ['4'], function (_export) {
  var _classCallCheck, AppController;
  ...
  return {
    ...
    execute: function () {
      ...
      AppController = function AppController($scope, $rootScope, socket, $http, $timeout) {
...
$__System.register('9', ['8'], function (_export) {
  'use strict';
  ...
  function socket($rootScope, $http) {
    ...
    return {
      init: function init(token, callback) {
      ...
      remove: function remove(eventsName) {
...
$__System.register('a', ['3', '5', '6', '9'], function (_export) {
  'use strict';

  var angular, UserController, AppController, SocketService, app;
  return {
    setters: [function (_) {
      angular = _['default'];
    }, function (_2) {
      UserController = _2['default'];
    }, function (_3) {
      AppController = _3['default'];
    }, function (_4) {
      SocketService = _4['default'];
    }],
    execute: function () {
      app = angular.module('coyote', []).controller('UserController', UserController).controller('AppController', AppController).service('Socket', SocketService).run(function ($rootScope, Socket) {

        // Restore token
        var token = localStorage.getItem('token');

        // Doing somethings on start
        var start = function start(loggedin) {
...
$__System.registerDynamic("10", ["c", "d", "e", "f"], false, function(__require, __exports, __module) {
...
$__System.register('1', ['11', 'a'], function (_export) {
...
//# sourceMappingURL=build.min.af78bffc.js.map